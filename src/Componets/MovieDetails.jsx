            ...
            <div className="w-full flex mt-3 ">
                ...
                <div className="ml-10">
                    ...
                    <h1 className="text-5xl font-bold hover:text-zinc-400">
                        ...
                        <span className="text-3xl font-semibold text-zinc-300">({info.detail.release_date.split("-")[0]})</span>
                    </h1>
                    ...
                    <div className="flex items-center gap-x-4  mt-2 text-lg mb-5">
                        ...
                        <span className="text-xl font-semibold text-zinc-300">({info.detail.release_date})</span>
                    ...
                    <h1 className="text-2xl font-medium mb-3">Movie Translated</h1>
